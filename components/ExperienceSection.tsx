...
const timelineData: TimelineItem[] = [
  {
    ...
    bullets: [
      ...
      "Building and maintaining automated CI/CD pipelines using GitHub Actions, GitHub Pages, and Jenkins for continuous integration, automated testing, and zero-friction deployment.",
    ...
    skills: ["CI/CD Pipelines", "GitHub Actions", "Jenkins", "GitHub Pages", "React.js", "Next.js", "Flutter", "Node.js", "REST APIs"],
  },
  {
